...
namespace WheelManufacturing.API.Controllers.Admin
{
    ...
    public class AdminMasterController : CustomBaseController
    {
        ...
        [Route("[action]")]
        [HttpPost]
        public async Task<ResponseModel> SaveMaterialName(MaterialName_Request parameters)
        {
            int result = await _adminMasterRepository.SaveMaterialName(parameters);
        ...
        [Route("[action]")]
        [HttpPost]
        public async Task<ResponseModel> GetMaterialNameList(MaterialName_Search parameters)
        {
            IEnumerable<MaterialName_Response> lstRoles = await _adminMasterRepository.GetMaterialNameList(parameters);
            _response.Data = lstRoles.ToList();
            _response.Total = parameters.Total;
            return _response;
        }
        ...
        [Route("[action]")]
        [HttpPost]
        public async Task<ResponseModel> GetMaterialNameById(long Id)
        {
            if (Id <= 0)
            {
                _response.Message = "Id is required";
        ...
        [Route("[action]")]
        [HttpPost]
        public async Task<ResponseModel> SaveSupplyTerm(SupplyTerm_Request parameters)
        {
            int result = await _adminMasterRepository.SaveSupplyTerm(parameters);
        ...
        [Route("[action]")]
        [HttpPost]
        public async Task<ResponseModel> GetSupplyTermList(SupplyTerm_Search parameters)
        {
            IEnumerable<SupplyTerm_Response> lstRoles = await _adminMasterRepository.GetSupplyTermList(parameters);
            _response.Data = lstRoles.ToList();
            _response.Total = parameters.Total;
            return _response;
        }
        ...
        [Route("[action]")]
        [HttpPost]
        public async Task<ResponseModel> GetSupplyTermById(long Id)
        {
            if (Id <= 0)
            {
                _response.Message = "Id is required";
            ...
            {
                var vResultObj = await _adminMasterRepository.GetSupplyTermById(Id);
                _response.Data = vResultObj;
            }
            return _response;
        }
        ...
        [Route("[action]")]
        [HttpPost]
        public async Task<ResponseModel> SaveTermsCondition(TermsCondition_Request parameters)
        {
            int result = await _adminMasterRepository.SaveTermsCondition(parameters);
        ...
        [Route("[action]")]
        [HttpPost]
        public async Task<ResponseModel> GetTermsConditionList(TermsCondition_Search parameters)
        {
            IEnumerable<TermsCondition_Response> lstRoles = await _adminMasterRepository.GetTermsConditionList(parameters);
            _response.Data = lstRoles.ToList();
            _response.Total = parameters.Total;
            return _response;
        }
        ...
        [Route("[action]")]
        [HttpPost]
        public async Task<ResponseModel> GetTermsConditionById(long Id)
        {
            if (Id <= 0)
            {
                _response.Message = "Id is required";
            ...
            {
                var vResultObj = await _adminMasterRepository.GetTermsConditionById(Id);
                _response.Data = vResultObj;
            }
            return _response;
        }
        ...
        [Route("[action]")]
        [HttpPost]
        public async Task<ResponseModel> SaveMachine(Machine_Request parameters)
        {
            int result = await _adminMasterRepository.SaveMachine(parameters);
        ...
        [Route("[action]")]
        [HttpPost]
        public async Task<ResponseModel> GetMachineById(long Id)
        {
            if (Id <= 0)
            {
                _response.Message = "Id is required";
            ...
            {
                var vResultObj = await _adminMasterRepository.GetMachineById(Id);
                _response.Data = vResultObj;
            }
            return _response;
        }
