...
namespace WheelManufacturing.Persistence.Repositories
{
    public class AdminMasterRepository : GenericRepository, IAdminMasterRepository
    {
        ...
        public async Task<int> SaveMachine(Machine_Request parameters)
        {
            DynamicParameters queryParameters = new DynamicParameters();
            queryParameters.Add("@Id", parameters.Id);
            ...
            return await SaveByStoredProcedure<int>("SaveMachine", queryParameters);
        }
        ...
        public async Task<Machine_Response?> GetMachineById(long Id)
        {
            DynamicParameters queryParameters = new DynamicParameters();
            queryParameters.Add("@Id", Id);
        ...
        public async Task<int> SavePaymentTerm(PaymentTerm_Request parameters)
        {
            DynamicParameters queryParameters = new DynamicParameters();
            queryParameters.Add("@Id", parameters.Id);
            queryParameters.Add("@PaymentTermName", parameters.PaymentTermName.SanitizeValue());
            queryParameters.Add("@IsActive", parameters.IsActive);
            queryParameters.Add("@UserId", SessionManager.LoggedInUserId);
